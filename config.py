class Config:
    ...
    DATASET = 'KSDD'  # KSDD, DAGM, STEEL, KSDD2
    ...
    TRAIN_NUM = 33
    NUM_SEGMENTED = 33
    RESULTS_PATH = "/content/drive/MyDrive/14_ブラザー工業様/tensorflow_ver_mixed-segdec-net/datasets/RESULTS" # TODO use when releasing
